...
class AdminController extends Controller
{
    ...
    public function postcapnhatttdonhang_admin(Request $req)
    {
        ...
        $req->session()->flash('status', 'Đã cập nhật!');
        return back();
    }
    ...
    public function postThemloaisp_admin(Request $reqaddloai)
    {
         $this->validate($reqaddloai,[
            ...
            'mo_ta.required' => 'Vui lòng nhập mô tả cho loại sản phẩm'
        ]);
        ...
        {
            echo "<script>alert('Bạn phải chọn hình đại diện cho loại sản phẩm mới!')</script>";
        ...
        $reqaddloai->session()->flash('status', 'Loại sản phẩm này đã có!');
    ...
    public function postCapnhatsp_admin(ThemspadminRequest $reqcapnhat)
    {
        ...
        else
        {
            ...
            $reqcapnhat->session()->flash('status', 'Loại sản phẩm đã ngừng bán không thể cập nhật sản phẩm!');
    ...
    public function postThemspsize_admin(ThemspSizeadminRequest $req)
    {
        ...
        {
            echo "<script>alert('Bạn phải chọn hình cho sản phẩm mới!')</script>";
    ...
    public function postLoginAdmin(Request $req)
    {
        ...
        {
            $thongbao = "Địa chỉ email hoặc mật khẩu không đúng";
