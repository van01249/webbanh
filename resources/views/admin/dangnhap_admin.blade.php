...
<title>Đăng nhập admin|Cake Bakery</title>
  ...
  .wrapper {
    ...
    <body>
            ...
            {{-- <div class="logo_cua_hang">
                <img src="{{url('/')}}/source/images/home/logo_v.png">
            </div> --}}
        ...
        <div id="noidung">
            <div class="login" id="element-box">
                <div class="m wbg">
                    ...
                    <div id="lock">
                    <img src="{{url('/')}}/source/images/home/logo_v.png" style="width:150px; height:120px">
                    </div>
                </div>
            </div>
        </div> <!-- nd -->
